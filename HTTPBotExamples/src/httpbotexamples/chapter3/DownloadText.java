...
public class DownloadText
{
  ...
  public static void main(String args[])
  {
    try
    {
    	String website= "https://www.gmail.com";
    	String dirTo = "G://JavaWorkspace//HTTP_Workspace//WorkspaceHTTPBot//HTMLPages//";
    	String fileTo = "gmail.html";
        DownloadText d = new DownloadText();
        d.download(website, dirTo +fileTo);
